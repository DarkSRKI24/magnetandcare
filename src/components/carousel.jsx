...
export function CarouselMT() {
  ...
  const handleTouchStart = (e) => {
    touchStartRef.current = e.touches[0].clientX; // Record the starting touch position
  };

  const handleTouchMove = (e) => {
    touchEndRef.current = e.touches[0].clientX; // Record the moving touch position
  };
  ...
  return (
    <Carousel
      ref={carouselRef} // Set ref for the carousel
      className="rounded-xl w-full h-[720px]"
      transition={{ duration: 2 }}
      autoplay={autoPlay}
      autoplayDelay={5000}
